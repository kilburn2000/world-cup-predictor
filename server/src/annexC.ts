// AUTO-GENERATED - FIFA Annex C: 2026 World Cup best-third-placed allocation.
// Source: Wikipedia template '2026 FIFA World Cup third-place table' (all 495 rows),
// validated against the actual R32 outcome. Do not edit by hand.
// Key = the 8 qualifying third-placed groups, sorted (e.g. 'BDEFIJKL').
// Value = { winnerGroup: thirdGroup } for winner slots A,B,D,E,G,I,K,L.
