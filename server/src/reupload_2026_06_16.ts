...
const DAVE_GROUP: G[] = [
  ...
  ["Argentina",3,0,"Algeria"],["Austria",1,0,"Jordan"],["Portugal",2,0,"Congo DR"],["England",0,0,"Croatia"],
  ["Ghana",1,0,"Panama"],["Uzbekistan",1,3,"Colombia"],["Czechia",1,2,"South Africa"],
  ["Switzerland",1,0,"Bosnia - Hertz"],["Canada",3,1,"Qatar"],["Mexico",3,0,"Rep. of Korea"],
